...
@Component({
  selector: 'app-query-c',
  standalone: true,
  imports: [CommonModule, FontAwesomeModule],
  templateUrl: './query-c.component.html',
  styleUrl: './query-c.component.css'
})
export class QueryCComponent {

  results: Observable<QueryCResponse>;
  sortedColumn: string = '';
  ...
  constructor(private ApiService: ApiService){
    this.results = this.ApiService.QueryC();
  }
...
interface QueryCResponse {
  results: Array<{
    RELEASE_DATE: string;
    SONG_NAME: string;
    POPULARITY: number;
    MOVING_AVG_POPULARITY: number;
  }>;
}
