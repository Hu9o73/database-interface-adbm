...
@Component({
  selector: 'app-query-b',
  standalone: true,
  imports: [CommonModule, FontAwesomeModule],
  templateUrl: './query-b.component.html',
  styleUrl: './query-b.component.css'
})
export class QueryBComponent {

  results: Observable<QueryBResponse>;
  sortedColumn: string = '';
  ...
  constructor(private ApiService: ApiService){
    this.results = this.ApiService.QueryB();
  }
...
interface QueryBResponse {
  results: Array<{
    ARTIST_NAME: string;
    TOTAL_SONGS: number;
    ARTIST_AVG_POPULARITY: number;
    GLOBAL_AVG_POPULARITY: number;
